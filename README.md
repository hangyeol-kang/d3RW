...
d3RW is a remote web application designed to control the d3 Designer using d3 API v2. With d3RW, you can remotely manage your d3 Designer to enhance your overall productivity.
...
- **Access for Remote Mobile Device**: Ensure that the remote mobile device has access to the Ethernet network. This access is necessary for the device to communicate with the d3RW application and control the d3 Designer remotely.
...
3. **Configure Settings:**
    ...
    - Set the host with the IP address obtained in step 1 and the port number in the `setting.ini` file. The application will not run if the host and port are not configured properly.
      ...
      <img src="https://github.com/hangyeol-kang/d3RW/assets/172173003/0b99ed50-2de1-4c77-8f47-6bc19bef0932" width="50%" height="50%">
...
**Transport Control Buttons**: Buttons for controlling transport. Function the same as in d3 Designer.
